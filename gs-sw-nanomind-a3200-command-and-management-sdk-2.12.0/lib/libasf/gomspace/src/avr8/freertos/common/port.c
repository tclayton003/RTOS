...
static unsigned portLONG ulCompareMatch = 0;
...
unsigned portCHAR ucLowByte;
    ...
    ucHighByte = ( unsigned portCHAR ) ( ulCompareMatch >> 8 & ( unsigned portLONG ) 0xff );
    portOCRH = ucHighByte;
