...
static const struct command power_subcommands[] = {
	{
		.name = "on",
		.help = "Power on",
...
static const struct command gatoss_subcommands[] = {
	{
		.name = "power",
		.help = "Power systems",
...
static const struct command __root_command gatoss_commands[] = {
	{
		.name = "gatoss",
		.help = "NanoCom ADS-B Receiver client",
