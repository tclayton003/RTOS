...
{
    // cppcheck-suppress nullPointerRedundantCheck - caused by uffs_Assert()
...
__attribute__((optimize("O0")))
        /* The AVR32 compiler breaks with internal compiler error if optimized */
#endif
        FindNextAllocatedInSmallPool(uffs_Pool *pool, void *from)
{
    u32 map = 0;
    uffs_PoolEntry *e;
    u32 i;
...
__attribute__((optimize("O0")))
#endif
        uffs_PoolFindNextAllocated(uffs_Pool *pool, void *from)
{
